                      ...
                      <div key={session.id} className="flex justify-between items-center p-2 rounded-lg">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                             ...
                             <p className="text-xs text-brand-text-light">{new Date(session.startTime).toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit'})}</p>
                          </div>
                        </div>
                        <span className="font-bold text-brand-text-dark text-lg">{formatDuration(session.duration)}</span>
                      </div>
                    );
                  })}
                </div>
